...
import { ChevronDownIcon, MicrophoneIcon } from '@heroicons/react/solid';
...
const Layout = ({ children = null }) => {
  ...
  return (
    <>
      <Head>
        <title>Raps Ninja</title>
        <meta
          name='title'
          content='Post your favorite rap lyrics and read other peoples favorites | Raps Ninja'
        />
      ...
      <div className='min-h-screen flex flex-col'>
            ...
            <div className='h-full px-4 flex justify-between items-center space-x-4'>
              <Link href='/'>
                <a className='flex items-center space-x-1'>
                  <MicrophoneIcon className='shrink-0 w-8 h-8 text-blue-500' />
                  <span className='text-xl font-semibold tracking-wide'>
                    Raps<span className='text-blue-600'>Ninja</span>
                  </span>
                </a>
              </Link>
        ...
        <main className='xl:container xl:mx-auto xl:px-10'>
